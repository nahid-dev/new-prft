...
const Footer = () => {
  ...
  return (
    <div className="bg-dark">
      ...
      <div
        className="border py-40 xl:bg-[url('/custom-svg/footer.svg')] bg-no-repeat"
      >
        <Container>
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-5">
            ...
            <div className="xl:ml-24 flex flex-col gap-10 items-center xl:items-start">
              ...
              <div >
                <p className="text-[15px] text-gray-400 font-semibold">Contact me</p>
                <div className="space-y-5">
                  <p className="text-white text-[40px] font-semibold">khalek.2md<span className="text-highlight">@</span>gmail.com</p>
                  <p className="text-gray-400 text-[22px] font-semibold">Looking for a skilled <span className="text-white">frontend developer</span> who builds <span className="text-white">high-performance,</span> scalable applications? Let’s connect!</p>
                </div>
              </div>
              <div>
                <HighlightButton onClick={handleOpenResumeModal} isGlowing={ true}>
                View my resume
              </HighlightButton>
            </div>
            </div>
