...
const data = [
  {
    ...
    quote: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Corrupti odit voluptatum, laudantium nulla distinctio molestias?"
  },
  {
    id: 2,
    name: "Md Tanjil",
...
export default function InfiniteMovingCardsSection() {
  return (
    (<div
      className=" bg-dark items-center justify-center relative overflow-hidden py-20">
      <InfiniteMovingCards items={data} direction="right" speed="slow" pauseOnHover={false} />
